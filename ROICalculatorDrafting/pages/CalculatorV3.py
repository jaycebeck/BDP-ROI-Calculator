...
def calculatorV3():
    ...
    if st.button("Calculate Profit"):
        ...
        st.write("1. 22 working days in a month / 30 days for online orders")
        st.write("2. 1.3x employee overhead")
        st.write("3. 2/3 of orders are taken still by phone and 1/3 online")
